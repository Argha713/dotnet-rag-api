...
// Argha - 2026-02-20 - Validates complex ChatRequest rules not expressible via data annotations 
...
public class ChatRequestValidator : AbstractValidator<ChatRequest>
{
    public ChatRequestValidator()
    {
        ...
        // Argha - 2026-02-20 - ConversationHistory: delegate each message to ConversationMessageValidator 
